function [subset1,subset2,subset3,subset4,subset5,subset6,subset7]=kcross7(sortedH)
%subsets for k=7 cross validation
...
index=crossvalind('Kfold',classindex,7);
...
for i=1:length(index)
    ...
    else subset7=vertcat(subset7,sortedH(i,:));
    end
end